...
describe("TodoApp Component", () => {
    ...
    test("renders header text", () => {
        render(_jsx(TodoApp, { token: "fake-token", setToken: jest.fn(), setLoggedOut: jest.fn() }));
    ...
    test("adds a new todo", async () => {
        ...
        render(_jsx(TodoApp, { token: "fake-token", setToken: mockSetToken, setLoggedOut: mockSetLoggedOut }));
    ...
    test("shows error message when adding todo fails", async () => {
        ...
        fireEvent.click(addButton);
        const errorMsg = await screen.findByText(/failed to add todo\. please try again\./i);
